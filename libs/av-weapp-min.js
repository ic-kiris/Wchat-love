! function(e, t) {
  ...
  return function(e) {
    ...
    (function() {
      ...
      S.keys = function(e) {
        ...
        var r, i, o = {},
          s = e;
        if (null == s) return o;
        S.isFunction(t) ? (i = S.allKeys(s), r = O(t, n)) : (i = k(arguments, !1, !1, 1), r = function(e, t, n) {
          return t in n
        }, s = Object(s));
        ...
        if (S.isFunction(t)) t = S.negate(t);
          ...
          var r = S.map(k(arguments, !1, !1, 1), String);
          t = function(e, t) {
      ...
      }, S.noop = function() {}, S.property = j, S.propertyOf = function(e) {
    ...
    t = e.exports = n(50), t.log = o, t.formatArgs = i, t.save = s, t.load = a, t.useColors = r, t.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : u(), t.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], t.formatters.j = function(e) {
      try {
    ...
    g.serializeObject = i, g.parseString = s, g.types = {
      ...
      for (var s in this.header) null != this.header[s] && t.setRequestHeader(s, this.header[s]);
    ...
    t = e.exports = i.debug = i.default = i, t.coerce = u, t.disable = s, t.enable = o, t.enabled = a, t.humanize = n(57), t.names = [], t.skips = [], t.formatters = {};
    var c
  }, function(e, t, n) {
    (function(t) {
      ! function(t, n) {
        ...
        function w(e, t) {
          t._state === oe ? E(e, t._result) : t._state === se ? T(e, t._result) : j(t, void 0, function(t) {
            return O(e, t)
          }, function(t) {
            return T(e, t)
          })
        ...
        function S(e, t, n) {
          t.constructor === e.constructor && n === d && t.constructor.resolve === p ? w(e, t) : n === ae ? T(e, ae.error) : void 0 === n ? E(e, t) : r(n) ? b(e, t, n) : E(e, t)
        }

        function O(t, n) {
          t === n ? T(t, v()) : e(n) ? S(t, n, m(n)) : E(t, n)
        }
        ...
        function U(e, t, n, i) {
          var o = r(n),
            ...
            c = void 0;
          if (o) {
            if (s = x(n, i), s === ue ? (c = !0, a = s.error, s = null) : u = !0, t === s) return void T(t, y())
          } else s = i, u = !0;
          t._state !== ie || (o && u ? O(t, s) : c ? T(t, a) : e === oe ? E(t, s) : e === se && T(t, s))
        }
        ...
        function R(e, t) {
          this._instanceConstructor = e, this.promise = new e(_), this.promise[re] || P(this.promise), Q(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? E(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && E(this.promise, this._result))) : T(this.promise, D())
        }
        ...
        function J(e) {
          this[re] = I(), this._result = this._state = void 0, this._subscribers = [], _ !== e && ("function" != typeof e && F(), this instanceof J ? k(this, e) : B())
        }
        ...
        return R.prototype._enumerate = function() {
          ...
          var r = this.promise;
          r._state === ie && (this._remaining--, e === se ? T(r, n) : this._result[t] = n), 0 === this._remaining && E(r, this._result)
    ...
    e.exports = function(e, t) {
      return !!(e && e.code && ~n.indexOf(e.code)) || (!!(t && t.status && t.status >= 500) || !!(e && "timeout" in e && "ECONNABORTED" == e.code))
    }
  }, function(e, t) {
    t.type = function(e) {
